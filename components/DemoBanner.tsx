...
export function DemoBanner({ onLoadDemo, onNewSprint, onReset, onOpenSprints, onOpenLeaderboard }: DemoBannerProps) {
  return (
    <div className="flex flex-col gap-3 rounded-lg border border-cyan-100 bg-white/90 px-4 py-3 shadow-sm md:flex-row md:items-center md:justify-between">
      <div>
        ...
        <p className="text-sm text-slate-600">Sample inputs only; AI still generates live results.</p>
      </div>
